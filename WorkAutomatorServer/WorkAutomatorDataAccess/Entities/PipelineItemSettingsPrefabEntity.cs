namespace WorkAutomatorDataAccess.Entities
{
    ...
    [Table("pipeline_item_settings_prefab")]
    public partial class PipelineItemSettingsPrefabEntity : IdEntity
    {
        ...
        {
            return pipeline_item_prefab.IsOwnedByCompany(companyId);
        }
    }
}
